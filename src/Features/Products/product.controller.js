...
export default class ProductController {
    ...
    async getOneProducts(req, res) {
        try{
            ...
            // console.log("**ProductController**",typeof(productId));   //string
    ...
    async updateProduct(req, res) {
        try{
            ...
            const update = req.body.updatedPizza;
            // console.log("productController_updateProduct: ", productId, "@ ", req.body.updatedPizza);
